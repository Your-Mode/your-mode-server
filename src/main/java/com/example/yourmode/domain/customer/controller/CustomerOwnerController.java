...
public class CustomerOwnerController {
    ...
    @PostMapping
    public BaseResponse<CustomerIdResponseDto> registerCustomer(@RequestBody CustomerRequestDto request) {
    ...
    public BaseResponse<CustomerIdResponseDto> deleteCustomer(@PathVariable Long customerId) {
    ...
    public BaseResponse<CustomerInfoResponseDto> getCustomerDetail(@PathVariable Long customerId) {
        ...
        CustomerInfoResponseDto customerDetail = customerService.getCustomerDetail(customerId);
